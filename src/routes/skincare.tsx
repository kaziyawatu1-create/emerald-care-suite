...
export const Route = createFileRoute("/skincare")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Shop premium skincare — serums, cleansers, moisturizers, sunscreens and acne solutions. Add to cart and order via WhatsApp or on delivery." },
