...
export function PageHeader({ eyebrow, title, subtitle, children, compact = false }: { eyebrow?: string; title: string; subtitle?: string; children?: ReactNode; compact?: boolean }) {
  return (
    <section className="relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/5 via-background to-gold/5">
      ...
      <div className={`relative mx-auto max-w-7xl px-4 md:px-8 ${compact ? "py-12 md:py-16" : "py-20 md:py-28"} text-center`}>
        {eyebrow && (
