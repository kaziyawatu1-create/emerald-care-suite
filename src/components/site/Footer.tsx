      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-muted-foreground">
            {[['/about','About Us'],['/categories','Laboratory'],['/pharmacy','Pharmacy'],['/skincare','Skincare'],['/perfumes','Perfumes'],['/home-services','Home Services'],['/contact','Contact'],['/dashboard','Dashboard']].map(([to,label]) => (
